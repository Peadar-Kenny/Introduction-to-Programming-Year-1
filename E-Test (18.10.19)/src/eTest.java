	...
	public static void main(String[] args) {
		...
		while (finished != true) {
			...
			if(input.hasNextInt() ) {
				...
				System.out.println("The average age entered is " + Math.round(averageAge)  + " and " 
						+ Math.round(teenagePercentage)  + "% of the ages correspond to teenagers ");
		...
		System.out.println("The average age entered was " + Math.round(averageAge) + " and " + Math.round(teenagePercentage) 
